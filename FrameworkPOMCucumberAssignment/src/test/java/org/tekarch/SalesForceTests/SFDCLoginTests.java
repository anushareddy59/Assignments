...
import org.tekarch.pages.salesForceHelperTest.SalesForceBasePage;

@Listeners(org.tekarch.utility.TestEventListenersUtility.class)
public class SFDCLoginTests extends SalesForceBaseTest {
...
//Testcase 3
	...
	public void rememberUserNameCheck() throws Exception {
		...
		driver = loginPage.clickLogin();
		SalesForceBasePage.waitUntilPageLoads();
		HomePage homepage = new HomePage (driver);
